...
<body class="login" style="display: flex; justify-content: flex-start; align-items: center; height: 100vh;">
    <div class="blue-box left-aligned">
        <div class="header-container-left">
            <h1 class="site-name">Site Name</h1>
            <h1 class="setup-heading">Ready to continue your Journey?</h1>
        </div>
